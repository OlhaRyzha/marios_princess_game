...
TRANSLATIONS: dict[Language, dict[str, str]] = {
    Language.UK: {
        ...
        "menu.quit": "Вийти",
        "menu.hint": "↑/↓: вибір  |  Enter: підтвердити  |  Esc: назад  |  L: English",
        "controls.title": "Керування",
        "controls.close": "Enter / Esc: закрити",
        "boss.about": "Опис:",
        "boss.strategy": "Стратегія:",
        "boss.goal": "Ціль:",
        "boss.hint": "←/→: змінити  •  Enter: обрати  •  Esc: закрити",
    ...
    Language.EN: {
        ...
        "menu.quit": "Quit",
        "menu.hint": "Up/Down: select  |  Enter: confirm  |  Esc: back  |  L: Українська",
        "controls.title": "Controls",
        "controls.close": "Enter / Esc: close",
        "boss.about": "About:",
        "boss.strategy": "Strategy:",
        "boss.goal": "Goal:",
        "boss.hint": "Left/Right: change  •  Enter: select  •  Esc: close",
